              ...
              <div className="space-y-8">
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">+91 9811138349</p>
                    <p className="text-slate-600">+91 9811138359</p>
                  </div>
                </div>
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">sales@eieindia.co.in</p>

                    <p className="text-slate-600">support@eieindia.co.in</p>
                  </div>
                </div>
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 leading-7">
                      ...
                      <br />
                      Office Address: Plot No. 58-59, Badli Extension, New
                      Delhi-110042
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">10:00 AM – 6:30 PM</p>
                  </div>
                </div>
              </div>
        ...
        <section className="pb-20">
          <div className="mx-auto max-w-7xl px-6">
            <div className="overflow-hidden rounded-3xl shadow-xl">
              <iframe
                title="Google Map"
                src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d218.69534174004855!2d77.15632322069816!3d28.715796156166466!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sus!4v1784741904023!5m2!1sen!2sus"
                width="100%"
                height="500"
                loading="lazy"
                allowFullScreen
